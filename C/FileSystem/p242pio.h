...
//-less read and writes from disk - have a write buffer
//-a better way to index inodes' names - don't want to search this list to find inode
//-global freelist, ilist - read once from disk on start-up, not whenever something is needed
//-global disk variable
//-multiblock reads/writes
//-test with big block sizes
//-create easy ways to write content to a file
//-check for duplicate names when creating files/directories
//-deal with memory leaks - THEY'RE EVERYWHERE!!!!
//-mathematically compute the maximum number of blocks given a set number of inodes
